...
public class RepeatAndMissing {
    ...
    public ArrayList<Integer> repeatedNumber(final List<Integer> a) {
        ...
        for(int i=0;i<a.size();i++){
            x = x.add(BigInteger.valueOf(a.get(i) - (i+1)));
            y = y.add(BigInteger.valueOf(a.get(i)*a.get(i) - (i+1)*(i+1)));
        }
        BigInteger z =  y.divide(x);
        output.add(z.add(x).intValue()/2);
        output.add(z.subtract(x).intValue()/2);
        return output;
    }
    ...
    public static void main(String[] args) {
        ...
        List<Integer> l1 = new ArrayList<>(Arrays.asList(new Integer[]{3, 1, 2, 5, 3}));
        System.out.println(rm.repeatedNumber(l1));
    }
}
